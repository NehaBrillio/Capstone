...
//	}
	...
	public String toString() {
		return "Customer [email=" + email + ", password=" + password + ", fname=" + fname + ", lname="
				+ lname + ", gender=" + gender + ", prime=" + prime + ", age=" + age + ", height=" + height
				+ ", weight=" + weight + ", mon=" + mon + ", tue=" + tue + ", wed=" + wed + ", thur=" + thur + ", fri="
				+ fri + ", sat=" + sat + ", sun=" + sun + "]";
	}
